namespace FabbraMentis.JsonConverter.Object
{
    ...
    {
        public string Name { get; set; } = string.Empty;              // stringa, default empty
        public string Source { get; set; } = string.Empty;            // stringa, default empty
        public int Page { get; set; } = 0;                            // int, default 0
        public List<string> ReprintedAs { get; set; } = []; // lista stringhe, default lista vuota
        public string Edition { get; set; } = string.Empty;           // stringa, default empty
        public string Type { get; set; } = string.Empty;              // stringa, default empty
        public string Rarity { get; set; } = string.Empty;            // stringa, default empty
        public double Weight { get; set; } = 0.0;                     // double, default 0.0
        public string WeaponCategory { get; set; } = string.Empty;   // stringa, default empty
        public string Age { get; set; } = string.Empty;               // stringa, default empty
        public List<string> Property { get; set; } = [];  // lista stringhe, default vuota
        public string Range { get; set; } = string.Empty;             // stringa, default empty
        public int Reload { get; set; } = 0;                          // int, default 0
        public string Dmg1 { get; set; } = string.Empty;              // stringa, default empty
        public string DmgType { get; set; } = string.Empty;           // stringa, default empty
        public bool Firearm { get; set; } = false;                    // bool, default false
        public bool Weapon { get; set; } = false;                     // bool, default false
        public string AmmoType { get; set; } = string.Empty;          // stringa, default empty
        public string ValueRarity { get; set; } = string.Empty;       // stringa, default empty
        public List<string> Mastery { get; set; } = [];   // lista stringhe, default vuota
        ...
        // List<object> può essere null o vuoto
